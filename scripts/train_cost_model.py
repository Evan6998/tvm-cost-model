...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--easy-gap", type=float, default=10.0, help="Easy pair runtime delta (ms)")
    parser.add_argument("--hard-gap", type=float, default=2.0, help="Hard pair runtime delta (ms)")
